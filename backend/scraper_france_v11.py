"""
Padel Alert â€” Scraper France v11 â€” par comitÃ© Ã— pÃ©riode (couverture 100%)

Fix critique v11 : [all]=0 (au lieu de =1) dans ligue_sumbit/ajax.
[all]=1 = "tout sÃ©lectionner" â†’ retourne toute la ligue (bug v8-v10).
[all]=0 = "comitÃ©s spÃ©cifiques seulement" â†’ filtre effectif par comitÃ©.
Source : capture rÃ©seau navigateur confirmÃ©e par Baptiste le 09/05/2026.

ProblÃ¨me v8/v9/v10 : plafond pagination Drupal ~40 pages (1200 items).
